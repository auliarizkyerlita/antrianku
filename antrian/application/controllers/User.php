...
class User extends CI_Controller {
	...
	public function add()
	{
		...
		$this->form_validation->set_message('is_unique', '{field} User telah digunakan, Silahkan Ganti');
		...
		{
			$this->template->load('template', 'user/formAdd');
		}
		else
		{
	...
	public function edit($id)
	{
		...
		if($this->form_validation->run()==FALSE)
		{
			...
			{
				$data['row'] = $query->row();
				$this->template->load('template','user/formEdit',$data);
			}
			else
			{
