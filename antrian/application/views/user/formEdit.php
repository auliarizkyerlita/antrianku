          ...
          <form role="form" id="quickForm" action="" method="post">
            <div class="card-body">
              <div class="form-group">
                ...
                value="<?=$this->input->post('fullname') ?? $row->name?>">
              </div>
              <div class="form-group">
                <label for="exampleInputNik">NIK</label>
                <input type="text" name="nik" class="form-control" id="exampleInputNik" placeholder="Masukan NIK dengan Angka"
                onkeypress="return hanyaAngka(event)" value="<?=$this->input->post('nik') ?? $row->nik?>" >
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label for="exampleInputPassword">Password<font color="red"> *Kosongkan jika Pasword tidak ingin berubah</font></label>
                <input type="password" name="password1" class="form-control" id="exampleInputPassword" placeholder="Password" >
              </div>
              <div class="form-group">
                <label for="exampleInputpassconf">Konfirmasi Password</label>
                <input type="password" name="passconf1" class="form-control" id="exampleInputpassconf" 
                placeholder="Konfirmasi Password" value="<?=$this->input->post('passconf')?>">
              </div>
              <div class="form-group ">
                <label>Level *</label>
